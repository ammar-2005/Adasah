        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6" dir="rtl">
            ...
            {filteredPosts.length > 0 ? (
                ...
                <div className="col-span-full text-center py-16">
                    <i className="fa-solid fa-search text-gray-500 text-5xl mb-4"></i>
                    <h3 className="text-white text-2xl font-bold mb-2">لا توجد نتائج بحث</h3>
                    <p className="text-gray-400 text-lg">
                        لم نعثر على مقالات تطابق كلمة البحث: <span className="text-orange-400 font-bold">"{searchQuery}"</span>
                    </p>
                </div>
            )}
        </div>
